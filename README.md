...
1. **Unit-level logic** (Calculator module)
2. **Library management functionality** (LibraryAccount module)
3. **Transactions module** (adding funds, fees, etc.)
4. **Integration tests** (Library + Transaction workflows)
5. **REST API testing** (GET, POST, PUT, PATCH, DELETE, error handling)
...
| --- | --- |
| **Python 3.11+** | Programming language for tests and modules |
| **pytest** | Testing framework used for unit, integration, and API tests |
| **pytest-html** | Generate HTML test reports |
| **requests** | Library to send HTTP requests for API testing |
| **PyCharm** | IDE used for development and running tests |
...
5. **API Testing with JSON Handling**
